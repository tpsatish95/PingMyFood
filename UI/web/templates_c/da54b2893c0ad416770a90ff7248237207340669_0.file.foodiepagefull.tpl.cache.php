<?php /* Smarty version 3.1.27, created on 2015-08-02 11:38:04
         compiled from "C:\xampp\htdocs\32hourstartup\web\templates\foodiepagefull.tpl" */ ?>
<?php
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_55bde4fcc53570_94431481',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_55bde4fcc53570_94431481')) {
function content_55bde4fcc53570_94431481 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '1244755bde4fcbe8c74_27930375';
?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<div class="col-lg-3">
				<div class="widget">
					...
					<div class="flickr_badge">
						<?php echo '<script'; ?>
 type="text/javascript" src="http://www.flickr.com/badge_code_v2.gne?count=8&amp;display=random&amp;size=s&amp;layout=x&amp;source=user&amp;user=34178660@N03"><?php echo '</script'; ?>
>
					</div>
					<div class="clear">
					</div>
...
<?php echo '<script'; ?>
 src="js/foodiepage/jquery.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="js/foodiepage/jquery.easing.1.3.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="js/foodiepage/bootstrap.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="js/foodiepage/jquery.fancybox.pack.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="js/foodiepage/jquery.fancybox-media.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="js/foodiepage/google-code-prettify/prettify.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="js/foodiepage/portfolio/jquery.quicksand.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="js/foodiepage/portfolio/setting.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="js/foodiepage/jquery.flexslider.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="js/foodiepage/animate.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="js/foodiepage/custom.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 type="text/javascript">
var obj = new XMLHttpRequest();
...
obj.open("GET","getcooks.php?locale="+'<?php echo $_smarty_tpl->tpl_vars['locale']->value;?>
',true);
obj.send();
<?php echo '</script'; ?>
>
