...
require_once $GLOBALS['THRIFT_ROOT'].'/S/Types.php';
require_once $GLOBALS['THRIFT_ROOT'].'/S/Senti.php';
...
try {
    ...
    // mysql query
    $check = $db->query("SELECT * FROM reviews where username ='$k'");
...
try {
    ...
    // mysql query
    $check = $db->query("SELECT * FROM reviews where username ='$cid' and dish = '$fid'");
